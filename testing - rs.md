...
**Issues Found:** Dr. Jean Dupont / Initial Cosultation / Lundi 05/01/2026 / date de naissance Obligatoire
...
**Test Result:** [ ] Pass [X] Fail
**Issues Found:** le RDV est confirmé malgré que la date est prise par Sarah !!
j'ai confirmé le RDV avec le compte Assistante mais une autre demande à été accéptée par le système
_________________________________________________________________
...
**Test Result:** [X] Pass [ ] Fail
**Issues Found:** je dois refaire les étapes a 0 au lieu d'avoir un bouton d'enregistrer et ajouter directement un autre patinet
_________________________________________________________________
...
**Test Result:** [ ] Pass [X] Fail
**Issues Found:** Le système a accépter le phone ABBB
_________________________________________________________________
...
**Test Result:** [X] Pass [ ] Fail
**Issues Found:** Le champ Docteur est obligatoire
_________________________________________________________________
...
**Test Result:** [X] Pass [ ] Fail
**Issues Found:** Actualisation après F5
_________________________________________________________________
...
**Issues Found:** le massage de sauvegarde réussite ne s'affiche pas
_________________________________________________________________
...
- il y a un décalage dans l'heur du RDV du vue Calnder et la vue détail.
_________________________________________________________________
...
**Issues Found:**
- Badge absent et pas de calcule d'age 
_________________________________________________________________
...
**Test Result:** [ ] Pass [X] Fail
**Issues Found:** la vue n'est pas clicable 
_________________________________________________________________
...
**Test Result:** [x] Pass [ ] Fail
**Issues Found:**
- les informations de la visites sont absentes, la durée
- l'annulation passera après l'ajout de la duration !!!
_________________________________________________________________
...
**Issues Found:**
- La recherche fonctionne que pour le nom
_________________________________________________________________
...
**Test Result:** [] Pass [x] Fail
**Issues Found:** il y a une seule vue carte de visites 
_________________________________________________________________
...
**Test Result:** [ ] Pass [X] Fail
**Issues Found:** Quand je clic sur le bonton pour créer un utilisateur la page affichée reste vide
_________________________________________________________________
...
**Test Result:** [ ] Pass [X] Fail
**Issues Found:** cette fonctionnalité n'exite pas pas de bouton pour maj le mot de passe
_________________________________________________________________
