    ...
    {#snippet headerChildren()}
        {#if data.user.role === "admin"}
            <button
                ...
                class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-bold rounded-xl text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all font-sans"
            >
                ...
                <div class="flex min-h-full items-center justify-center p-4">
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="bg-white px-6 py-6 sm:p-8 space-y-4">
