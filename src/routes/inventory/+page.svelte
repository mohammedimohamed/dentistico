...
<div class="min-h-screen bg-gray-50">
    <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            ...
            <a href={data.user.role === 'doctor' ? '/doctor/dashboard' : '/assistant/dashboard'} class="text-sm text-indigo-600 hover:text-indigo-900 font-medium">&larr; Retour Dashboard</a>
        </div>
    </header>
