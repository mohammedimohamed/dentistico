<script lang="ts">
    ...
    const icons = {
        ...
        lab: '<path stroke-linecap="round" stroke-linejoin="round" d="M14.25 2.25l-.105.105a1.125 1.125 0 00-.319.794V9.75M9.75 9.75V3.149a1.125 1.125 0 00-.319-.794L9.326 2.25M9.75 9.75a2.25 2.25 0 00-2.25 2.25v2.302c0 .497-.197.973-.548 1.324l-3.358 3.358c-.512.512-.512 1.343 0 1.855.512.512 1.343.512 1.855 0l3.358-3.358a1.875 1.875 0 011.324-.548H13.87c.497 0 .973.197 1.324.548l3.358 3.358c.512.512 1.343.512 1.855 0 .512-.512.512-1.343 0-1.855l-3.358-3.358a1.875 1.875 0 01-.548-1.324V12a2.25 2.25 0 00-2.25-2.25M9.75 9.75h4.5" />',
    };
</script>
