...
<aside class="bg-gray-900 text-white min-h-screen transition-all duration-300 flex flex-col {isCollapsed ? 'w-20' : 'w-64'}">
    ...
    <div class="p-4 border-t border-gray-800">
        <div class="flex items-center gap-3 mb-4">
            ...
            {#if !isCollapsed}
                <div class="flex flex-col overflow-hidden">
                    <span class="text-xs font-bold text-indigo-400 uppercase tracking-widest">User</span>
        ...
        <form action="/logout" method="POST" use:enhance={() => {
            ...
            <button type="submit" class="w-full flex items-center gap-4 px-4 py-2 rounded-lg text-red-400 hover:bg-red-500/10 hover:text-red-300 transition-colors">
